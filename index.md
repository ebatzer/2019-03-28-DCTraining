...
carpentry: "Data Carpentry Training"    # what kind of Carpentry (must be either "lc" or "dc" or "swc").  
                      # Be sure to update the Carpentry type in _config.yml as well.  
venue: "UC Davis"        # brief name of host site without address (e.g., "Euphoric State University")
address: "1 Shields Ave"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "USA"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "Davis"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "Davis"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Davis"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Davis?"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: Davis.      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: Davis!        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Bubba"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Earl"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
